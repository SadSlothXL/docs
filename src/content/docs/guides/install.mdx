...
Your game folder is located in your SteamLibrary (default `C:\Program Files (x86)\Steam\steamapps\common`), you can find it through Steam by selecting Call of Duty: Modern Warfare 2 (2009) in your library, right-clicking it and selecting Manage -> Browse local files.
